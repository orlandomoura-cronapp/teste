...
public interface EventoDAO extends JpaRepository<Evento, java.lang.Integer> {
  ...
  public Evento findOne(@Param(value="id") java.lang.Integer id);
  ...
  public Page<TipoMinisterio> listTipoMinisterioGeneralSearch(@Param(value="search") java.lang.String search, @Param(value="id") java.lang.Integer id, Pageable pageable);
  ...
  public Page<TipoMinisterio> listTipoMinisterioSpecificSearch(@Param(value="id") java.lang.Integer id, @Param(value="nome") java.lang.String nome, Pageable pageable);
  ...
  public Page<TipoMinisterio> listTipoMinisterio(@Param(value="id") java.lang.Integer id, Pageable pageable);
  ...
  public int deleteTipoMinisterio(@Param(value="instanceId") java.lang.Integer instanceId, @Param(value="relationId") java.lang.Integer relationId);
  ...
  public Page<TipoMinisterio> listTipoMinisterio_2GeneralSearch(@Param(value="search") java.lang.String search, @Param(value="id") java.lang.Integer id, Pageable pageable);
  ...
  public Page<TipoMinisterio> listTipoMinisterio_2SpecificSearch(@Param(value="id") java.lang.Integer id, @Param(value="nome") java.lang.String nome, Pageable pageable);
  ...
  public Page<TipoMinisterio> listTipoMinisterio_2(@Param(value="id") java.lang.Integer id, Pageable pageable);
  ...
  public int deleteTipoMinisterio_2(@Param(value="instanceId") java.lang.Integer instanceId, @Param(value="relationId") java.lang.Integer relationId);
  ...
  public Page<Evento> findEventosByCandidato(@Param(value="id") java.lang.Integer id, Pageable pageable);
